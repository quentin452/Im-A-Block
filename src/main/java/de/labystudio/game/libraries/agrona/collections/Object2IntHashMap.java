...
/**
 * {@link Map} implementation specialised for int values using open addressing and
...
public class Object2IntHashMap<K> implements Map<K, Integer> {
     ...
     */
    public Object2IntHashMap(@DoNotSub final int initialCapacity, final float loadFactor, final int missingValue) {
    ...
    public void putAll(final Object2IntHashMap<? extends K> map) {
        ...
        for (@DoNotSub
        int index = 0, remaining = map.size; remaining > 0 && index < length; index++) {
    ...
    public boolean equals(final Object o) {
        ...
        final int[] values = this.values;
        final int missingValue = this.missingValue;
        final int thatMissingValue = o instanceof Object2IntHashMap ? ((Object2IntHashMap<?>) o).missingValue
            : missingValue;
        for (@DoNotSub
     ...
     */
    public final class EntrySet extends AbstractSet<Entry<K, Integer>> {
    ...
    abstract class AbstractIterator<T> implements Iterator<T> {
        ...
        protected final void findNext() {
            ...
            for (@DoNotSub
            int i = posCounter - 1; i >= stopCounter; i--) {
                @DoNotSub
     ...
     */
    public final class EntryIterator extends AbstractIterator<Entry<K, Integer>> implements Entry<K, Integer> {
