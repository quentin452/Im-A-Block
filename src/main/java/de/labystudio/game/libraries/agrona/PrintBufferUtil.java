...
public final class PrintBufferUtil {
     ...
     * @param length how much should we print.
     */
    public static void appendPrettyHexDump(final StringBuilder dump, final DirectBuffer buffer, final int offset,
        final int length) {
    ...
    static final class HexUtil {
        ...
        static String hexDump(final DirectBuffer buffer, final int fromIndex, final int length) {
            ...
            for (int dstIdx = 0, srcIdx = fromIndex; srcIdx < endIndex; srcIdx++, dstIdx += 2) {
                System.arraycopy(HEXDUMP_TABLE, getUnsignedByte(buffer, srcIdx) << 1, buf, dstIdx, 2);
            }
        ...
        static void appendPrettyHexDump(final StringBuilder dump, final DirectBuffer buffer, final int offset,
            final int length) {
