 ...
 */
package de.labystudio.game.libraries.agrona.nio;

import de.labystudio.game.libraries.agrona.LangUtil;
import de.labystudio.game.libraries.agrona.nio.NioSelectedKeySet;
...
public class TransportPoller implements AutoCloseable {
     ...
     */
    public static final int ITERATION_THRESHOLD = Integer
        .getInteger(ITERATION_THRESHOLD_PROP_NAME, ITERATION_THRESHOLD_DEFAULT);
