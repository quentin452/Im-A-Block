...
public interface OutputManager {
    ...
    /**
     * Create named output and call {@link de.labystudio.game.libraries.agrona.generation.ResourceConsumer#accept(Object)}.
     *
     * @param name             name of the output to create.
     * @param resourceConsumer to be called.
     */
    default void withOutput(final String name, final de.labystudio.game.libraries.agrona.generation.ResourceConsumer<Writer> resourceConsumer) {
