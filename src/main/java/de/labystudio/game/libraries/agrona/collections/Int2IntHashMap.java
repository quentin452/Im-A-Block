...
public class Int2IntHashMap implements Map<Integer, Integer> {
     ...
     * @param missingValue    for the map that represents null.
     */
    public Int2IntHashMap(@DoNotSub final int initialCapacity, @DoNotSub final float loadFactor,
     ...
     */
    public Int2IntHashMap(@DoNotSub final int initialCapacity, @DoNotSub final float loadFactor, final int missingValue,
    ...
    public void forEachInt(final IntIntConsumer consumer) {
        ...
        for (@DoNotSub
        int valueIndex = 1, remaining = size; remaining > 0 && valueIndex < length; valueIndex += 2) {
    ...
    public boolean containsValue(final int value) {
        ...
        if (missingValue != value) {
            ...
            for (@DoNotSub
            int valueIndex = 1; remaining > 0 && valueIndex < length; valueIndex += 2) {
    ...
    public void putAll(final Int2IntHashMap map) {
        final EntryIterator it = map.entrySet()
            .iterator();
        while (it.hasNext()) {
            it.findNext();
     ...
     * @param value             to be merged with the existing value associated with the key or, if no existing value or
     *                          a null
    ...
    public String toString() {
        ...
        while (true) {
            ...
            sb.append(entryIterator.getIntKey())
                .append('=')
                .append(entryIterator.getIntValue());
    ...
    abstract class AbstractIterator {
        ...
        protected final void findNext() {
            ...
            for (@DoNotSub
            int keyIndex = positionCounter - 2, stop = stopCounter; keyIndex >= stop; keyIndex -= 2) {
                @DoNotSub
    ...
    public final class EntryIterator extends AbstractIterator
        ...
        public final class MapEntry implements Entry<Integer, Integer> {
            ...
            public boolean equals(final Object o) {
                ...
                return (e.getKey() != null && e.getValue() != null) && (e.getKey()
                    .equals(k)
                    && e.getValue()
                        .equals(v));
            }
     ...
     */
    public final class EntrySet extends AbstractSet<Entry<Integer, Integer>> {
