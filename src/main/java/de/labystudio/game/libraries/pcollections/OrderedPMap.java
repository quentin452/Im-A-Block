 ...
 *
 * <p>
 * Note that, like {@link LinkedHashMap}, insertion order is not affected if a key is re-inserted
 * into the map.
 *
 * <p>
 * (Note: this is different from {@link PSortedMap}, which keeps elements in the order specified
 * by {@link Comparable#compareTo(Object)} or {@link java.util.Comparator#compare(Object,
 * Object)}.)
 *
 * @param <K>
 * @param <V>
...
public class OrderedPMap<K, V> extends AbstractUnmodifiableMap<K, V> implements PMap<K, V>, Serializable {
    ...
    private static final OrderedPMap<Object, Object> EMPTY = new OrderedPMap<Object, Object>(
        Empty.map(),
        Empty.sortedMap());
