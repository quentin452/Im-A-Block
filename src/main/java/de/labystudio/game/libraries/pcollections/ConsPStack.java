...
public final class ConsPStack<E> extends AbstractUnmodifiableSequentialList<E> implements PStack<E>, Serializable {
    ...
    public static <E> ConsPStack<E> from(final Collection<? extends E> list) {
        if (list instanceof ConsPStack) return (ConsPStack<E>) list; // (actually we only know it's ConsPStack<? extends
                                                                     // E>)
    ...
    public ConsPStack<E> subList(final int start, final int end) {
        ...
        return this.<E>empty()
            .plusAll(reversed); // plusAll reverses again
    }
    ...
    public ConsPStack<E> with(final int i, final E e) {
        ...
        return suffix.plus(e)
            .plusAll(reversed.rest); // plusAll reverses again
    }
