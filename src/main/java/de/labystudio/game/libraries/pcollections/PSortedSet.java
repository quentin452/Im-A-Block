 ...
 * (according to some {@link Comparator}), and with various methods to obtain specific
 ...
 *
 * <p>
 * (Note: this is different from {@link OrderedPSet}, which keeps elements in the order that they
 * were added to the set.)
 *
 * <p>
 * Null values are disallowed unless the subclass specifically supports them; attempts to add a
 * null value will result in {@link NullPointerException}.
 *
 * <p>
 * Every PSortedSet is a {@link java.util.Set} and more specifically a {@link PSet}, but as with
 ...
 *
 * <p>
 * Every PSortedSet is a {@link java.util.SortedSet} and more specifically a {@link
 * NavigableSet}, but the implementations of PSortedSet provided by this library
...
public interface PSortedSet<E> extends PSet<E>, NavigableSet<E> {
    ...
    @Override
    public PSortedSet<E> subSet(E fromElement, boolean fromInclusive, E toElement, boolean toInclusive);
