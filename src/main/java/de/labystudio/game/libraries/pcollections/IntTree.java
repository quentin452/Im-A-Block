...
class IntTree<V> implements Serializable {
     ...
     *
     * <p>
     * In other words, this method must not result in any change in the order of the keys in this,
     ...
     *
     * <p>
     * This method will create an _invalid_ tree if delta>0 and the distance between the largest
