 ...
 *
 * <p>
 * (Note: this is different from {@link PSortedSet}, which keeps elements in the order specified
...
public class OrderedPSet<E> extends AbstractUnmodifiableSet<E> implements PSet<E>, Serializable {
    ...
    private static final OrderedPSet<Object> EMPTY = new OrderedPSet<Object>(Empty.map(), Empty.sortedMap());
